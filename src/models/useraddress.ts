...
interface UserAddressCreationInterface extends Optional<ShippingAddressInterface, 'id'> { }

// Sequelize Model
@Table
export default class UserAddress extends Model<ShippingAddressInterface, UserAddressCreationInterface> {
    @ForeignKey(() => User)
    @AllowNull(true)
    @Default(null)
    @Column
